...
import { ArrowLeft, Package, Zap, AlertTriangle } from "lucide-react";
...
export default function BikeFinderResults({ result, onClear }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* AI Disclaimer */}
      <div className="flex items-start gap-2 rounded-md border border-amber-500/30 bg-amber-500/5 px-4 py-3 text-sm text-muted-foreground">
        <AlertTriangle className="mt-0.5 h-4 w-4 shrink-0 text-amber-500" />
        <p>
          Compatibility results are generated by AI and may not always be accurate.
          Please verify fitment before purchasing. If you're unsure,{" "}
          <a href="/contact" className="font-medium text-primary underline underline-offset-2 hover:text-primary/80">
            contact us
          </a>{" "}
